 ...
 */
public class Uebung4  extends MainActivity implements View.OnClickListener{
    ...
    private void begin() {
        ...
        for(;Aufgaben>0;) {
            Random rnd = new Random();
            int welchezahl = 1+rnd.nextInt(4);
            if(schwer==3) {
                if(welchezahl==1){
                        zahl2 = 1+ rnd.nextInt(9);
                        zahl1 = zahl2*(1+rnd.nextInt(4));
                        txt1.setText("" + zahl1);
                        txt2.setText("" + zahl2);
                        Aufgaben--;
                        txt4.setText(""+Aufgaben);
                        ...
                        txt3.setText("x");
                        break;
                    } else if(welchezahl==3) {

                        zahl2 = 1+ rnd.nextInt(140/(schwer*3));
                        zahl1 = zahl2+ rnd.nextInt(150/(schwer*3));
                        txt1.setText("" + zahl1);
                        txt2.setText("" + zahl2);
                        Aufgaben--;
                        txt4.setText(""+Aufgaben);
                ...
                if(welchezahl==1){
                    ...
                    zahl2 = 1+ rnd.nextInt(140/(schwer*2));
                    zahl1 = zahl2+ rnd.nextInt(150/(schwer*2));
                    txt1.setText("" + zahl1);
                    txt2.setText("" + zahl2);
                    Aufgaben--;
                    txt4.setText(""+Aufgaben);
                ...
                if(welchezahl==1){
                    ...
                    zahl2 = 1+ rnd.nextInt(140/schwer);
                    zahl1 = zahl2+ rnd.nextInt(150/schwer);
                    txt1.setText("" + zahl1);
                    txt2.setText("" + zahl2);
                    Aufgaben--;
                    txt4.setText(""+Aufgaben);
